...
object Lineage extends Component: 
  ...
  val value = post(
    ...
    link = TitleLink("lineage-paper", "PLDI Paper"),
    year = "2023"
  )(
...
object Bidir extends Component:
  val value = post(
    ...
    link = TitleLink("bidirectional-paper", "EUROGRAPHICS Paper"),
    year = "2021"
  )(
...
object Impala extends Component:
  val value = post(
    ...
    spaced(
      ...
      t / "Impala combines this strategy with a few key insights to maximize performance:"
    ),
    ul(
      li /
